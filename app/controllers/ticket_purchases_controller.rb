class TicketPurchasesController < ApplicationController
  ...
  def create
    ...
    message = TicketPurchase.purchase(@conference, current_user, params[:tickets][0], params[:code_id])
    if message.blank?
  ...
  def ticket_purchase_params
    params.require(:ticket_purchase).permit(:ticket_id, :user_id, :conference_id, :quantity, :code_id)
  end
end
